 ...
 * with debugging.
 */
void ColorfulRingOfDeath(int i)
{
	uint16_t ring = 1;
	while (1)
	{
...
void NMI_Handler(void)       {}
void HardFault_Handler(void) { ColorfulRingOfDeath(0); }
void MemManage_Handler(void) { ColorfulRingOfDeath(1); }
void BusFault_Handler(void)  { ColorfulRingOfDeath(2); }
void UsageFault_Handler(void){ ColorfulRingOfDeath(3); }
void SVC_Handler(void)       {}
void DebugMon_Handler(void)  {}
void PendSV_Handler(void)    {}
